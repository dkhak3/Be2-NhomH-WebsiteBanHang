    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="bg-light rounded h-100 p-4">
                ...
                <a class="btn btn-primary" href="{{ route('index') }}">Danh sách</a>
                <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="product_price" name="product_price" maxlength="10">
                    </div>
                    ...
                    <div class="form-floating mb-3">
                        <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea product_description" name="product_description" style="height: 150px;" maxlength="255"></textarea>
